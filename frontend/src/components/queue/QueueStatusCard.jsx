      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-start gap-5">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium flex items-center gap-1.5 whitespace-nowrap">
              by{" "}
        ...
        <div className="flex gap-4 md:gap-8 border-t md:border-t-0 md:border-l border-slate-100 pt-6 md:pt-0 md:pl-8">
          <div className="text-center md:text-left">
            <div className="flex items-center gap-2 text-slate-400 mb-1 whitespace-nowrap">
              <Clock size={16} />
