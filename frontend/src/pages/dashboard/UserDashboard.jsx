  ...
  if (error) {
    return (
      ...
      >
        ...
        <button
          onClick={refetch}
          className="group relative overflow-hidden inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm whitespace-nowrap"
          style={{
            background: "#3AA0FF",
            color: "#0B1320",
            fontFamily: "var(--font-heading)",
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(242,179,61,0.08) 0%, transparent 70%)",
            }}
          />
        </div>
